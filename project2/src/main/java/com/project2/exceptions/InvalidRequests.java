...
public class InvalidRequests extends RuntimeException {
    public InvalidRequests (String message){
    ...
    */
    ...
    public static void main(String[] args) {
        ...
        */
        ...
        try{
            throw new InvalidRequests("this could be a message for the end user, or just for a dev working on code");
